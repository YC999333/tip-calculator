...
function App() {
  ...
  const handleFormChange = (e) => {
    ...
    const data = {
      ...
      tips: form.custom ? Number(form.custom) : Number(form.tips),
    ...
    const tipAmount = (tip / data.person).toFixed(2);
    const total = ((data.bill + tip) / data.person).toFixed(2);
                ...
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-5 px-4 md:px-8 lg:px-4">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="bg-lightgraycyan h-10 rounded-lg text-darkgraycyan1 text-lg w-full"
                    >
                      {custom ? null : "Custom"}
                    </button>
                    {custom ? (
